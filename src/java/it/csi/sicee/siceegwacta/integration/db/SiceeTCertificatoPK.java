...
/**
 * The primary key class for the SICEE_T_CERTIFICATO database table.
 * 
 */
@Embeddable
public class SiceeTCertificatoPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof SiceeTCertificatoPK)) {
			return false;
		}
		SiceeTCertificatoPK castOther = (SiceeTCertificatoPK)other;
		return 
